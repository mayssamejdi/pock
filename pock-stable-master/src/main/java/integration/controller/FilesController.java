...
public class FilesController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file,@RequestHeader String Authorization) {
        String message = "";
        try {
    ...
    @GetMapping("/files")
    public ResponseEntity<List<FileInfo>> getListFiles(@RequestHeader String Authorization) {
    ...
    @ResponseBody
    public ResponseEntity<Resource> getFile(@PathVariable String filename,@RequestHeader String Authorization) {
     ...
     @GetMapping("/create")
    public boolean createDocument(@RequestParam(required = true,defaultValue = "testdocument.txt") String docName,@RequestHeader String Authorization){
    ...
    public void download(@RequestBody DocumentInfo document, @RequestHeader String Authorization){
        cmisService.downloadDocumentByPath(document);
    }

    @GetMapping("/content")
    public ResponseEntity<List<DocumentInfo>> getContent(@RequestHeader String Authorization){
