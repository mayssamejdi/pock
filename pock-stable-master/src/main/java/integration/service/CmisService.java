...
public class CmisService {
    ...
    public void documentUpload() throws IOException {
        ...
        final String uploadURI = "http:/10.1.40.66:8080/alfresco/service/api/upload";
        final String authURI = "http://10.1.40.66:8080/alfresco/service/api/login";
    ...
    public void downloadDocumentByPath(){
        ...
        try{
            ...
            File file = new File("C:\\Users\\mayssa.mejdi\\Desktop" + doc.getName());
            file.createNewFile();
